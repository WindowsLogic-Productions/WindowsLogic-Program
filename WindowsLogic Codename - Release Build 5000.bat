@echo off
title WindowsLogic Program Build 5000
color 0b
:home
title Log in to WindowsLogic Program Build 5000
color 0b
cls
echo.
...
:Load2
cls
echo Creating User... [---      ] Creating Local User Account...
...
ping localhost -n 2 >nul
cls
echo Creating User... [---      ] Excalibur...
ping localhost -n 2 >nul
cls
echo Creating User... [ ---     ] OK
ping localhost -n 2 >nul
cls
echo Creating User... [  ---    ] FOOLS!!!
ping localhost -n 2 >nul
cls
echo Creating User... [   ---   ] OK
ping localhost -n 2 >nul
...
:Loading
cls
echo Loading Personal Settings... [-         ] 10 Percent
ping localhost >nul
cls
echo Loading Personal Settings... [--        ] 20 Percent
ping localhost >nul
cls
echo Loading Personal Settings... [---       ] 30 Percent
ping localhost >nul
cls
echo Loading Personal Settings... [----      ] 40 Percent
ping localhost >nul
cls
echo Loading Personal Settings... [-----     ] 50 Percent
ping localhost >nul
cls
echo Loading Personal Settings... [------    ] 60 Percent
ping localhost >nul
cls
echo Loading Personal Settings... [-------   ] 70 Percent
ping localhost >nul
cls
echo Loading Personal Settings... [--------  ] 80 Percent
ping localhost >nul
cls
echo Loading Personal Settings... [--------- ] 90 Percent
ping localhost >nul
cls
echo Loading Personal Settings... [----------] 100 Percent
ping localhost >nul
cls
goto OK1
:OK1
...
:intromain
color 0a
title WindowsLogic Program Codename: Release v1.0 Build 2600
cls
echo.
echo ******************************************************************
